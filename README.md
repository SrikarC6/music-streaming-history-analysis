...
> **Note:** The slideshow presentation itself is available to view! Simply download the provided `presentation-stt-180-ho-srikar-chitturi.zip` file (located within `Slideshow` folder, extract it, and open the `presentation-stt-180.html` file in your web browser.
